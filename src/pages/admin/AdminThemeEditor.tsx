...
const DEFAULTS: Record<string, string> = {
  ...
  // ── New ecommerce-br keys ──────────────────────────────
  theme_color_primary: "#7D2EB5",
  theme_color_secondary: "#1BB794",
  theme_color_accent: "#FF6B35",
  theme_color_background: "#FFFFFF",
  theme_color_foreground: "#333333",
  theme_color_muted: "#999999",
  theme_color_border: "#EEEEEE",
  theme_color_error: "#E74C3C",
  theme_font_heading: "Poppins",
  theme_font_weight_body: "400",
  theme_font_weight_heading: "600",
  theme_section_spacing: "60",
  theme_section_spacing_mobile: "40",
  theme_border_radius_global: "8",
  theme_btn_border_radius: "6",
  theme_btn_height: "48",
  theme_btn_font_size: "14",
  theme_btn_font_weight: "500",
  theme_btn_letter_spacing: "0",
  theme_btn_primary_bg: "#7D2EB5",
  theme_btn_primary_text: "#FFFFFF",
  theme_btn_addtocart_bg: "#1BB794",
  theme_btn_addtocart_text: "#FFFFFF",
  theme_btn_checkout_bg: "#000000",
  theme_btn_checkout_text: "#FFFFFF",
  theme_parcela_enabled: "true",
  theme_parcela_max: "12",
  theme_parcela_color_price: "#1BB794",
  theme_pix_enabled: "true",
  theme_pix_discount: "5",
  theme_pix_color: "#4381fc",
  theme_pix_cart_enabled: "true",
  theme_whatsapp_float_enabled: "false",
  theme_whatsapp_number: "",
  theme_whatsapp_position: "right",
  theme_whatsapp_color: "#25D366",
  theme_announcement_enabled: "true",
  theme_announcement_bg: "#7D2EB5",
  theme_announcement_text_color: "#FFFFFF",
  theme_announcement_height: "36",
  theme_announcement_font_size: "11",
  theme_header_design: "1",
  theme_header_bg: "#FFFFFF",
  theme_header_text_color: "#222222",
  theme_header_height_mobile: "64",
  theme_logo_width: "120",
  theme_footer_design: "1",
  theme_footer_bg: "#222222",
  theme_footer_text: "#AAAAAA",
  theme_footer_show_payment: "true",
  theme_collection_columns_desktop: "4",
  theme_collection_columns_mobile: "2",
  theme_collection_gap: "16",
  theme_collection_sidebar: "none",
  theme_collection_infinite_scroll: "false",
  theme_cart_type: "drawer",
  theme_cart_drawer_width: "400",
  theme_cart_show_shipping_bar: "true",
  theme_cart_free_shipping_value: "199",
  theme_cart_show_upsell: "true",
  theme_product_border_radius: "12",
  theme_product_border_enabled: "true",
  theme_product_shadow_enabled: "true",
  theme_product_show_rating: "true",
  theme_product_show_addtocart: "false",
  theme_product_show_sale_label: "true",
  theme_product_show_new_label: "true",
  theme_pdp_image_click: "zoom",
  theme_pdp_sticky_addtocart: "true",
  theme_pdp_show_share: "true",
  theme_pdp_show_quantity: "true",
  theme_pdp_show_buy_now: "true",
  theme_pdp_show_payment_icons: "true",
  theme_pdp_variant_style: "buttons",
};
...
const THEME_PRESETS: ThemePreset[] = [
  ...
  {
    name: "Luxo", description: "Fashion contemporâneo, fundo branco, botões pretos arredondados — inspirado em Glozin",
    values: {
      // Colors — clean white + black
      theme_primary_h: "0", theme_primary_s: "0", theme_primary_l: "8",
      theme_bg_h: "0", theme_bg_s: "0", theme_bg_l: "100",
      theme_fg_h: "0", theme_fg_s: "0", theme_fg_l: "12",
      theme_accent_h: "0", theme_accent_s: "0", theme_accent_l: "96",
      theme_muted_h: "0", theme_muted_s: "0", theme_muted_l: "96",
      theme_border_h: "0", theme_border_s: "0", theme_border_l: "91",
      // Also set HEX keys for ecommerce-br compatibility
      theme_color_primary: "#1A1A1A",
      theme_color_background: "#FFFFFF",
      theme_color_foreground: "#1F1F1F",
      theme_color_accent: "#F5F5F5",
      theme_color_muted: "#F5F5F5",
      theme_color_border: "#E8E8E8",
      // Typography — clean geometric sans-serif
      theme_font_display: "Jost", theme_font_body: "Jost",
      theme_font_heading: "Jost",
      theme_heading_weight: "500", theme_body_weight: "400",
      theme_font_weight_heading: "500", theme_font_weight_body: "400",
      theme_letter_spacing_editorial: "0.02",
      // Layout
      theme_border_radius: "0.5", theme_spacing_section: "80", theme_max_width: "1440",
      theme_border_radius_global: "8",
      theme_section_spacing: "80",
      // Buttons — solid black, rounded (pill-like)
      theme_button_style: "solid", theme_button_radius: "24",
      theme_button_height: "48", theme_button_font_size: "13",
      theme_button_letter_spacing: "0.04", theme_button_font_weight: "500",
      theme_btn_border_radius: "24", theme_btn_height: "48",
      theme_btn_font_size: "13", theme_btn_font_weight: "500",
      // Announcement bar — dark
      theme_statusbar_bg_h: "0", theme_statusbar_bg_s: "0", theme_statusbar_bg_l: "12",
      theme_statusbar_fg_h: "0", theme_statusbar_fg_s: "0", theme_statusbar_fg_l: "100",
      theme_statusbar_visible: "true", theme_statusbar_height: "36", theme_statusbar_font_size: "12",
      theme_announcement_enabled: "true",
      theme_announcement_bg: "#1F1F1F",
      theme_announcement_text_color: "#FFFFFF",
      theme_announcement_height: "36", theme_announcement_font_size: "12",
      // Nav — white bg, dark text, left-aligned logo
      theme_nav_bg_h: "0", theme_nav_bg_s: "0", theme_nav_bg_l: "100",
      theme_nav_fg_h: "0", theme_nav_fg_s: "0", theme_nav_fg_l: "12",
      theme_nav_height: "68", theme_nav_logo_height: "28",
      theme_nav_style: "left-aligned", theme_nav_sticky: "true",
      theme_nav_transparent_hero: "false",
      theme_nav_show_search: "true", theme_nav_show_wishlist: "true",
      theme_header_bg: "#FFFFFF", theme_header_text_color: "#1F1F1F",
      theme_header_height_mobile: "60", theme_logo_width: "28",
      // Product cards — clean, with hover effect
      theme_card_aspect: "3/4", theme_card_hover_effect: "zoom",
      ...
      theme_collection_columns_desktop: "4", theme_collection_columns_mobile: "2",
      theme_collection_gap: "20",
      theme_product_border_radius: "8", theme_product_border_enabled: "false",
      theme_product_shadow_enabled: "false", theme_product_show_rating: "true",
      theme_product_show_addtocart: "true", theme_product_label_style: "rounded",
      theme_product_img_count: "2",
      // PDP
      theme_pdp_layout: "side-by-side", theme_pdp_gallery_style: "thumbnails",
      theme_pdp_show_breadcrumb: "true", theme_pdp_show_editor_notes: "true",
      theme_pdp_show_details_grid: "true", theme_pdp_show_trust_badges: "true",
      theme_pdp_sticky_info: "true", theme_pdp_show_related: "true", theme_pdp_show_sku: "false",
      theme_pdp_show_quantity: "true", theme_pdp_show_buy_now: "true",
      theme_pdp_show_share: "true", theme_pdp_show_payment_icons: "true",
      // Category
      theme_category_layout: "standard", theme_category_show_filters: "true",
      ...
      theme_cart_drawer_width: "420", theme_cart_show_shipping_bar: "true",
      theme_cart_free_shipping_value: "199", theme_cart_show_upsell: "true",
      // Footer — dark
      theme_footer_bg_h: "0", theme_footer_bg_s: "0", theme_footer_bg_l: "8",
      theme_footer_fg_h: "0", theme_footer_fg_s: "0", theme_footer_fg_l: "85",
      ...
      theme_footer_bg: "#141414", theme_footer_text: "#D9D9D9",
      theme_footer_design: "1",
      // Animations
      theme_animation_enabled: "true", theme_animation_intensity: "medium",
      theme_hover_scale: "1.04", theme_transition_speed: "400", theme_overlay_opacity: "0.04",
      // Checkout
      theme_checkout_style: "single-page", theme_checkout_show_trust: "true",
      theme_checkout_show_order_bumps: "true", theme_checkout_show_coupon: "true",
    },
  ...
  {
    name: "Copa Brasil 2026",
    description: "Loja temática da Copa do Mundo — verde, amarelo e azul, energia patriótica e contagem regressiva",
    values: {
      // Verde brasileiro como cor primária
      theme_primary_h: "140", theme_primary_s: "70", theme_primary_l: "22",
      theme_bg_h: "48", theme_bg_s: "30", theme_bg_l: "98",
      theme_fg_h: "140", theme_fg_s: "40", theme_fg_l: "12",
      theme_accent_h: "48", theme_accent_s: "95", theme_accent_l: "55",
      theme_muted_h: "48", theme_muted_s: "20", theme_muted_l: "94",
      theme_border_h: "140", theme_border_s: "20", theme_border_l: "85",
      theme_destructive_h: "0", theme_destructive_s: "84", theme_destructive_l: "55",
      theme_color_primary: "#0E7A3C",
      theme_color_background: "#FBF8EE",
      theme_color_foreground: "#0F2A18",
      theme_color_accent: "#F9D71C",
      theme_color_muted: "#F1ECD9",
      theme_color_border: "#D5DCC8",
      // Tipografia esportiva e bold
      theme_font_display: "Montserrat", theme_font_body: "Inter",
      theme_font_heading: "Montserrat",
      theme_heading_weight: "800", theme_body_weight: "400",
      theme_font_weight_heading: "800", theme_font_weight_body: "400",
      theme_letter_spacing_editorial: "0.08",
      // Layout
      theme_border_radius: "0.25", theme_spacing_section: "80", theme_max_width: "1440",
      theme_border_radius_global: "4", theme_section_spacing: "80",
      // Botões — verde sólido, retos, esportivos
      theme_button_style: "solid", theme_button_radius: "4",
      theme_button_height: "52", theme_button_font_size: "13",
      theme_button_letter_spacing: "0.15", theme_button_font_weight: "700",
      theme_btn_border_radius: "4", theme_btn_height: "52",
      theme_btn_font_size: "13", theme_btn_font_weight: "700",
      // Status bar — amarelo vibrante com texto verde
      theme_statusbar_bg_h: "48", theme_statusbar_bg_s: "95", theme_statusbar_bg_l: "55",
      theme_statusbar_fg_h: "140", theme_statusbar_fg_s: "70", theme_statusbar_fg_l: "18",
      theme_statusbar_visible: "true", theme_statusbar_height: "38", theme_statusbar_font_size: "12",
      theme_statusbar_text_1: "⚽ Faltam poucos dias para a Copa — produtos oficiais Brasil",
      theme_statusbar_text_2: "🚚 Frete grátis acima de R$199 para todo o Brasil",
      theme_statusbar_text_3: "🇧🇷 Vai Brasil! Compre antes que esgote",
      theme_statusbar_rotation_speed: "3500",
      theme_announcement_enabled: "true",
      theme_announcement_bg: "#F9D71C",
      theme_announcement_text_color: "#0E4A22",
      theme_announcement_height: "38", theme_announcement_font_size: "12",
      // Nav — verde escuro
      theme_nav_bg_h: "140", theme_nav_bg_s: "70", theme_nav_bg_l: "18",
      theme_nav_fg_h: "48", theme_nav_fg_s: "30", theme_nav_fg_l: "98",
      theme_nav_height: "72", theme_nav_logo_height: "32",
      theme_nav_style: "centered", theme_nav_sticky: "true",
      theme_nav_transparent_hero: "false",
      theme_nav_show_search: "true", theme_nav_show_wishlist: "true",
      theme_header_bg: "#0E4A22", theme_header_text_color: "#FBF8EE",
      theme_header_height_mobile: "64", theme_logo_width: "32",
      // Cards — formato esportivo, bordas marcantes
      theme_card_aspect: "square", theme_card_hover_effect: "zoom",
      theme_card_show_category: "true", theme_card_show_badge: "true",
      theme_card_badge_style: "filled", theme_card_price_weight: "700",
      theme_card_name_size: "15", theme_card_gap: "16",
      theme_card_columns_desktop: "4", theme_card_columns_mobile: "2",
      theme_collection_columns_desktop: "4", theme_collection_columns_mobile: "2",
      theme_collection_gap: "16",
      theme_product_border_radius: "4", theme_product_border_enabled: "true",
      theme_product_shadow_enabled: "true", theme_product_show_rating: "true",
      theme_product_show_addtocart: "true", theme_product_label_style: "filled",
      theme_product_img_count: "2",
      // PDP
      theme_pdp_layout: "side-by-side", theme_pdp_gallery_style: "thumbnails",
      theme_pdp_show_breadcrumb: "true", theme_pdp_show_editor_notes: "true",
      ...
      theme_category_filter_position: "sidebar",
      theme_category_show_count: "true", theme_category_show_sort: "true",
      theme_category_products_per_page: "20",
      // Cart
      theme_cart_style: "drawer", theme_cart_width: "420",
      theme_cart_drawer_width: "420", theme_cart_show_shipping_bar: "true",
      theme_cart_free_shipping_value: "199", theme_cart_show_upsell: "true",
      // Footer — verde escuro, patriótico
      theme_footer_bg_h: "140", theme_footer_bg_s: "70", theme_footer_bg_l: "12",
      theme_footer_fg_h: "48", theme_footer_fg_s: "30", theme_footer_fg_l: "92",
      theme_footer_layout: "three-column", theme_footer_show_social: "true",
      theme_footer_show_newsletter: "true", theme_footer_show_payment_icons: "true",
      theme_footer_bg: "#0A3318", theme_footer_text: "#F1ECD9",
      theme_footer_design: "1",
      // Animações enérgicas
      theme_animation_enabled: "true", theme_animation_intensity: "high",
      theme_hover_scale: "1.05", theme_transition_speed: "300", theme_overlay_opacity: "0.08",
      // Checkout
      theme_checkout_style: "single-page", theme_checkout_show_trust: "true",
      theme_checkout_show_order_bumps: "true", theme_checkout_show_coupon: "true",
    },
    sections: [
      {
        ...
        description: "A camisa, a torcida, a paixão. Tudo o que você precisa para viver a Copa do Mundo de 2026 ao lado da maior torcida do planeta.",
        cta_text: "Comprar Agora",
        link_url: "/category/copa",
        config: {
          height: "full",
          text_position: "center",
          overlay_opacity: "0.4",
          blocks: [
            { type: "cta", text: "Ver Coleção Oficial", link: "/category/camisas", style: "primary" },
            { type: "cta", text: "Acessórios", link: "/category/acessorios", style: "outline" },
          ],
        },
      },
      {
        section_type: "countdown",
        title: "Contagem regressiva para a Copa",
        subtitle: "A maior festa do futebol está chegando — prepare sua torcida",
        cta_text: "Garantir camisa",
        link_url: "/category/camisas",
        config: {
          end_date: "2026-06-11T17:00:00.000Z",
          show_days: "true",
          show_hours: "true",
          show_minutes: "true",
          show_seconds: "true",
      ...
      {
        section_type: "collection_list",
        title: "Vista o Brasil",
        subtitle: "Tudo para torcer com estilo, da arquibancada ao bar da esquina.",
        config: {
          columns: "4",
          blocks: [
            { title: "Camisas Oficiais", link: "/category/camisas", image: "" },
            { title: "Acessórios", link: "/category/acessorios", image: "" },
            { title: "Bandeiras", link: "/category/bandeiras", image: "" },
            { title: "Colecionáveis", link: "/category/colecionaveis", image: "" },
          ],
        },
      },
      {
        ...
        subtitle: "Produtos oficiais com a paixão de quem ama o Brasil",
      },
      {
        section_type: "full_width_banner",
        title: "100% BRASIL",
        subtitle: "Hexa em vista",
        description: "Camisas oficiais, edições limitadas e itens colecionáveis com a estampa da nossa seleção. Estoque limitado — quando acabar, acabou.",
        cta_text: "Comprar Edição Limitada",
        link_url: "/category/edicao-limitada",
        config: { overlay_opacity: "0.5", text_color: "light" },
      },
      {
        section_type: "marquee",
        config: {
          ...
          size: "large",
          blocks: [
            { content: "⚽ VAI BRASIL", link: "" },
            { content: "🇧🇷 HEXACAMPEÃO", link: "" },
            { content: "⭐ COPA 2026", link: "" },
            { content: "🏆 RUMO AO HEXA", link: "" },
            { content: "💚💛 PAIXÃO NACIONAL", link: "" },
          ],
        },
      },
      {
        ...
        subtitle: "Lançamentos semanais até o início da Copa",
      },
      {
        section_type: "multicolumn",
        ...
        config: {
          ...
          alignment: "center",
          blocks: [
            { title: "Produtos Oficiais", description: "Trabalhamos apenas com licenciados, garantindo qualidade e autenticidade.", image: "", button_text: "", button_link: "" },
            { title: "Entrega Garantida na Copa", description: "Compre até 30 dias antes da estreia do Brasil e receba antes do primeiro jogo.", image: "", button_text: "", button_link: "" },
            { title: "Pague em até 12x", description: "Parcelamento sem juros no cartão e 10% off no PIX.", image: "", button_text: "", button_link: "" },
          ],
        },
      },
      {
        section_type: "testimonials",
        title: "A torcida aprova",
        subtitle: "Brasileiros de todos os cantos do país escolhem a gente para vestir a paixão.",
        config: {
          blocks: [
            { author: "Rafael M.", quote: "Comprei a camisa oficial e chegou em 3 dias. Qualidade impecável, vou usar em todos os jogos do Brasil!", rating: "5", location: "Salvador, BA" },
            { author: "Patrícia L.", quote: "Bandeira gigante chegou perfeita. A festa em casa vai ser inesquecível 🇧🇷", rating: "5", location: "Curitiba, PR" },
            { author: "André S.", quote: "Atendimento nota 10 e produtos originais. Já é meu lugar pra tudo de Copa.", rating: "5", location: "Recife, PE" },
          ],
        },
      },
      {
        section_type: "newsletter",
        title: "Entre para a torcida oficial",
        subtitle: "Receba lançamentos, ofertas e ative o alerta de drops exclusivos da Copa.",
      },
    ],
  },
];
                    ...
                    <SettingsTab
                      ...
                      onApplyPreset={async (preset) => {
                        ...
                        if (preset.sections && preset.sections.length > 0) {
                          try {
                            const availableSectionTypes = new Set(
                              themeRegistry.getAvailableSections(activeThemeId ?? undefined).map((section) => section.type)
                            );

                            const normalizedSections = preset.sections
                              .filter((section) => availableSectionTypes.size === 0 || availableSectionTypes.has(section.section_type))
                              .map((section, index) => ({
                                ...
                                image_url_2: section.image_url_2 || null,
                                config: section.config ? (section.config as unknown as Json) : null,
                                sort_order: index,
                                is_visible: true,
                              }));

                            const { data: existing, error: selectError } = await supabase.from("homepage_sections").select("id");
                            ...
                            if (existing && existing.length > 0) {
                              const { error: deleteError } = await supabase
                                ...
                                .delete()
                                .in("id", existing.map((section) => section.id));
                              if (deleteError) throw deleteError;
                            }

                            if (normalizedSections.length > 0) {
                              const { error: insertError } = await supabase.from("homepage_sections").insert(normalizedSections);
                            ...
                            toast.error("Não foi possível aplicar o layout do preset.");
                            return;
                          }
                        }
